          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-12 items-center">
            ...
            <div className="md:col-span-2 flex justify-center">
              <motion.div
                ...
                className="relative p-8 rounded-3xl border w-64 h-64 flex flex-col items-center justify-center gap-4"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {milestones.map((m, i) => (
              <motion.div
                ...
                whileHover={{ y: -4 }}
                className="p-8 rounded-2xl border flex items-start gap-5 transition-all duration-300"
                style={{ background: 'var(--bg-surface)', borderColor: 'var(--border-color)' }}
              >
