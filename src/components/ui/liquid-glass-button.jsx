  ...
  return (
    <>
      ...
      >
        ...
        <div className="pointer-events-none z-10 text-white">
          {children}
        </div>
        <GlassFilter />
      </Comp>
...
const metalButtonVariants = (
  ...
  return {
    ...
    button: cn(
      "relative z-10 m-[1px] rounded-md inline-flex h-11 transform-gpu cursor-pointer items-center justify-center overflow-hidden rounded-md px-6 py-2 text-sm leading-none font-semibold will-change-transform outline-none border-none",
      colors.button,
      colors.textColor,
      colors.textShadow,
    ),
...
const ShineEffect = ({ isPressed }) => {
  return (
    ...
    >
      <div className="absolute inset-0 rounded-md bg-gradient-to-r from-transparent via-neutral-100 to-transparent animate-shine" />
    </div>
  );
};
