...
const GitHubButton = () => {
  ...
  return (
    <div className="flex justify-center pointer-events-auto">
      <a
        href="https://github.com/shafaann"
        target="_blank"
        ...
        <button
          ...
          <span className="flex items-center justify-between px-4 gap-2 rounded-lg group-hover:text-yellow-400 text-white text-xl font-semibold tracking-wide whitespace-nowrap">
            <FaStar className="group-hover:fill-yellow-400 fill-white w-6 h-6 flex-shrink-0 sm:inline-block hidden" />
            <FaGithub className="sm:hidden inline-block group-hover:fill-yellow-400 fill-white w-6 h-6 flex-shrink-0" />
